...
require('telekasten').setup({
    home = vim.fn.expand("~/workspace/zettelkasten/zettel"), -- Put the name of your notes directory here
    dailies = vim.fn.expand("~/workspace/zettelkasten/daily"), -- Put the name of your notes directory here
