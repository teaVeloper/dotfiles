...
####
getantidote/use-omz
# integrate system clipboard with zsh
ohmyzsh/ohmyzsh path:lib/clipboard.zsh
# color man pages
ohmyzsh/ohmyzsh path:plugins/colored-man-pages
# https://github.com/ohmyzsh/ohmyzsh/tree/master/plugins/copybuffer
# Ctrl-o copy current command
ohmyzsh/ohmyzsh path:plugins/copybuffer
# copyfile command, copy file into clipboard
ohmyzsh/ohmyzsh path:plugins/copyfile
# copypath command, copy absolute path of current dir
...
# this breaks my personal settings!
